        ...
        <div class="mb-3">
            ...
            <textarea class="myedit" name="content_en" placeholder="English Content">
                {{ $product->content_en}}</textarea>
        </div>

        <div class="mb-3">
            <label>Arabic Content</label>
            <textarea class="myedit" placeholder="Arabic Content" name="content_ar">
            {{ $product->content_ar}}</textarea>
        </div>
